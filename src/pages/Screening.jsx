              ...
              <>
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex justify-center gap-6 mt-8">
                    <Button size="large">Cegah Kekerasan Seksual</Button>
                    <Button size="large">Hindari Seks pranikah</Button>
                    <Button size="large">Infeksi Menular Seksual</Button>
                  </div>
                </div>
              </>
            }
            ...
            {conclusion === "Sedang" &&
              <>
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex justify-center gap-6 mt-8">
                    <Button size="large">Tahap Perkembangan remaja</Button>
                    <Button size="large">Hindari Seks Pranikah</Button>
                    <Button size="large">Infeksi menular Seksual</Button>
                  </div>
                </div>
            ...
            {(conclusion === "Tinggi" || conclusion === "Berat") &&
              <>
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex justify-center gap-6 mt-8">
                    <Button size="large">Tahap Perkembangan remaja</Button>
                    <Button size="large">Kesehatan reproduksi</Button>
                    <Button size="large">Cegah kekerasan Seksual</Button>
                  </div>
                </div>
              </>
